...
const EditEpisode = () => {
  ...
  const handleExport = (format: string) => {
    // Adicionar lógica real de exportação aqui (pode chamar uma Edge Function)
    toast({
      title: "Exportação (Não implementado)",
      description: `A funcionalidade de exportar como ${format.toUpperCase()} será adicionada.`,
    });
  };
